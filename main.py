...
def get_model(IN_WIDTH, INT_HEIGHT):
    '''
    获得模型
    '''
...
def train_model(save_model_path, BATCH_SIZE, IN_SIZE):
    ...
    model = get_model(IN_WIDTH, INT_HEIGHT)
...
def main():
    ...
    #～～～～～～～～～～～～～～～～～  模型训练及预测part1  ～～～～～～～～～～～～～～～～～
    weights_path = '/home/sycv/workplace/meixun/TIANCHI_XUELANG_AI/weight/model_weight1.hdf5'
    train_model(save_model_path=weights_path, BATCH_SIZE=6, IN_SIZE=500)    # 线上0.9157
    predict(weights_path=weights_path, IN_SIZE=500)
    #
    # weights_path = '/home/sycv/workplace/meixun/TIANCHI_XUELANG_AI/weight/model_weight2.hdf5'
    # train_model(save_model_path=weights_path, BATCH_SIZE=4, IN_SIZE=550)    # 线上0.918
    # # predict(weights_path=weights_path, IN_SIZE=550)
    # #
    # weights_path = '/home/sycv/workplace/meixun/TIANCHI_XUELANG_AI/weight/model_weight3.hdf5'
